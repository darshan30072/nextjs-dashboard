              ...
              <form onSubmit={onSubmit}>
                  ...
                  <div className="flex gap-4 mt-3">
                    ...
                    <div className="w-1/2">
                      ...
                      <select
                        ...
                        className={`${commonInputClasses} appearance-none ${formErrors.category ? "border-red-500" : "border-gray-500"}`}
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-3">
                  <button
                    type="button"
                    onClick={() => router.back()}
                    className="w-full sm:w-auto px-4 py-2 bg-gray-200 rounded cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="w-full sm:w-auto px-6 py-2 bg-orange-500 text-white rounded hover:bg-orange-600 cursor-pointer"
                  >
                    Update
                  </button>
                </div>
